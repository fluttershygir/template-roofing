    ...
    <div className="min-h-screen bg-slate-950 text-slate-50 font-sans selection:bg-orange-500/30">
      ...
      <header className="fixed top-0 w-full z-50 bg-slate-950/80 backdrop-blur-md border-b border-slate-800">
        <div className="container mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <Button className="bg-orange-600 hover:bg-orange-500 text-white rounded-full px-6 transition-all hover:scale-105">
            Free Inspection
          </Button>
        </div>
      </header>
            ...
            <div className="grid md:grid-cols-3 gap-8">
                {[
                    { 
                        ...
                        desc: "Complete tear-off and installation using premium materials like asphalt, metal, or tile.",
                        icon: Home
                    },
                    { 
                        title: "Storm Damage Repair", 
                        desc: "Expert restoration for wind, hail, and water damage. We work directly with your insurance.",
                        icon: Shield
                    },
                    { 
                        title: "Gutter Systems", 
                        desc: "Seamless gutter installation and gutter guards to protect your home's foundation.",
                        icon: CheckCircle2
                    },
                ].map((service, i) => (
                    <Card key={i} className="bg-slate-900 border-slate-800 hover:border-orange-500/50 transition-colors group">
                        <CardHeader>
                            <div className="w-12 h-12 rounded-lg bg-slate-800 text-orange-400 flex items-center justify-center mb-4 group-hover:bg-orange-950/50 transition-colors">
                        ...
                        <CardContent>
                            ...
                            <div className="flex items-center text-sm font-medium text-orange-400 group-hover:translate-x-1 transition-transform cursor-pointer">
